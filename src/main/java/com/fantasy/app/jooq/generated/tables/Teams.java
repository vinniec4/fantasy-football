...
public class Teams extends TableImpl<TeamsRecord> {
    ...
    private static final long serialVersionUID = 415240936;
     ...
     */
    public final TableField<TeamsRecord, String> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.CLOB.nullable(false), this, "");
    ...
    /**
     * The column <code>fantasy_football.teams.image_url</code>.
     */
    public final TableField<TeamsRecord, String> IMAGE_URL = createField(DSL.name("image_url"), org.jooq.impl.SQLDataType.CLOB, this, "");
